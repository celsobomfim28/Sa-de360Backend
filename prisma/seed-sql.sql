...
BEGIN
    ...
    INSERT INTO patients (id, cpf, cns, "fullName", "motherName", "birthDate", sex, street, number, neighborhood, state, "microAreaId", "primaryPhone", "isChild", "createdById", "createdAt", "updatedAt")
    VALUES (patient_id, '10000000001', '100000000010001', 'Pedro Henrique Souza', 'Juliana Souza', NOW() - INTERVAL '6 months', 'MALE', 'Rua Principal', '100', 'Centro', 'CE', ma01_id, '(85) 99999-9999', true, admin_id, NOW(), NOW());
    ...
    patient_id := gen_random_uuid();
    INSERT INTO patients (id, cpf, cns, "fullName", "motherName", "birthDate", sex, street, number, neighborhood, state, "microAreaId", "primaryPhone", "hasDiabetes", "hasHypertension", "isElderly", "createdById", "createdAt", "updatedAt")
    VALUES (patient_id, '10000000002', '100000000010002', 'Carlos Pereira Lima', 'Rosa Lima', NOW() - INTERVAL '65 years', 'MALE', 'Rua Principal', '101', 'Centro', 'CE', ma01_id, '(85) 99999-9998', true, true, true, admin_id, NOW(), NOW());
    ...
    -- Diabética Mulher
    patient_id := gen_random_uuid();
    INSERT INTO patients (id, cpf, cns, "fullName", "motherName", "birthDate", sex, street, number, neighborhood, state, "microAreaId", "primaryPhone", "hasDiabetes", "isWoman", "createdById", "createdAt", "updatedAt")
    VALUES (patient_id, '10000000003', '100000000010003', 'Maria Oliveira Costa', 'Ana Costa', NOW() - INTERVAL '60 years', 'FEMALE', 'Rua Principal', '102', 'Centro', 'CE', ma01_id, '(85) 99999-9997', true, true, admin_id, NOW(), NOW());
    INSERT INTO diabetes_indicators (id, "patientId", "d1Status", "d2Status", "d3Status", "d4Status", "d5Status", "d6Status", "lastUpdated") 
    VALUES (gen_random_uuid(), patient_id, 'RED', 'RED', 'RED', 'RED', 'RED', 'RED', NOW());

    -- Mulher
    patient_id := gen_random_uuid();
    INSERT INTO patients (id, cpf, cns, "fullName", "motherName", "birthDate", sex, street, number, neighborhood, state, "microAreaId", "primaryPhone", "isWoman", "createdById", "createdAt", "updatedAt")
    VALUES (patient_id, '10000000004', '100000000010004', 'Fernanda Costa Alves', 'Lucia Alves', NOW() - INTERVAL '35 years', 'FEMALE', 'Rua Principal', '103', 'Centro', 'CE', ma01_id, '(85) 99999-9996', true, admin_id, NOW(), NOW());
    INSERT INTO woman_health_indicators (id, "patientId", "g1Status", "g2Status", "lastUpdated") 
    VALUES (gen_random_uuid(), patient_id, 'RED', 'RED', NOW());

    -- Idoso
    patient_id := gen_random_uuid();
    INSERT INTO patients (id, cpf, cns, "fullName", "motherName", "birthDate", sex, street, number, neighborhood, state, "microAreaId", "primaryPhone", "isElderly", "createdById", "createdAt", "updatedAt")
    VALUES (patient_id, '10000000005', '100000000010005', 'José Antônio Ferreira', 'Maria Ferreira', NOW() - INTERVAL '68 years', 'MALE', 'Rua Principal', '104', 'Centro', 'CE', ma01_id, '(85) 99999-9995', true, admin_id, NOW(), NOW());
    INSERT INTO elderly_indicators (id, "patientId", "f1Status", "f2Status", "lastUpdated") 
    VALUES (gen_random_uuid(), patient_id, 'RED', 'RED', NOW());
END $$;
...
BEGIN
    ...
    patient_id := gen_random_uuid();
    INSERT INTO patients (id, cpf, cns, "fullName", "motherName", "birthDate", sex, street, number, neighborhood, state, "microAreaId", "primaryPhone", "isChild", "createdById", "createdAt", "updatedAt")
    VALUES (patient_id, '20000000001', '200000000010001', 'Ana Clara Rodrigues', 'Carla Rodrigues', NOW() - INTERVAL '1 year', 'FEMALE', 'Rua Norte', '200', 'Bairro Norte', 'CE', ma02_id, '(85) 98888-8888', true, admin_id, NOW(), NOW());
    INSERT INTO childcare_indicators (id, "patientId", "b1Status", "b2Status", "b3Status", "b4Status", "vaccineStatus", "b5Status", "lastUpdated") 
    VALUES (gen_random_uuid(), patient_id, 'RED', 'RED', 'RED', 'RED', 'NOT_STARTED', 'RED', NOW());

    -- Hipertenso
    patient_id := gen_random_uuid();
    INSERT INTO patients (id, cpf, cns, "fullName", "motherName", "birthDate", sex, street, number, neighborhood, state, "microAreaId", "primaryPhone", "hasHypertension", "createdById", "createdAt", "updatedAt")
    VALUES (patient_id, '20000000002', '200000000010002', 'João Silva Santos', 'Helena Santos', NOW() - INTERVAL '55 years', 'MALE', 'Rua Norte', '201', 'Bairro Norte', 'CE', ma02_id, '(85) 98888-8887', true, admin_id, NOW(), NOW());
    INSERT INTO hypertension_indicators (id, "patientId", "e1Status", "e2Status", "e3Status", "e4Status", "lastUpdated") 
    VALUES (gen_random_uuid(), patient_id, 'RED', 'RED', 'RED', 'RED', NOW());

    -- Gestante
    patient_id := gen_random_uuid();
    INSERT INTO patients (id, cpf, cns, "fullName", "motherName", "birthDate", sex, street, number, neighborhood, state, "microAreaId", "primaryPhone", "isPregnant", "isWoman", "createdById", "createdAt", "updatedAt")
    VALUES (patient_id, '20000000003', '200000000010003', 'Mariana Souza Lima', 'Paula Lima', NOW() - INTERVAL '28 years', 'FEMALE', 'Rua Norte', '202', 'Bairro Norte', 'CE', ma02_id, '(85) 98888-8886', true, true, admin_id, NOW(), NOW());
    ...
    -- Diabético Idoso
    patient_id := gen_random_uuid();
    INSERT INTO patients (id, cpf, cns, "fullName", "motherName", "birthDate", sex, street, number, neighborhood, state, "microAreaId", "primaryPhone", "hasDiabetes", "isElderly", "createdById", "createdAt", "updatedAt")
    VALUES (patient_id, '20000000004', '200000000010004', 'Roberto Carlos Dias', 'Joana Dias', NOW() - INTERVAL '72 years', 'MALE', 'Rua Norte', '203', 'Bairro Norte', 'CE', ma02_id, '(85) 98888-8885', true, true, admin_id, NOW(), NOW());
    INSERT INTO diabetes_indicators (id, "patientId", "d1Status", "d2Status", "d3Status", "d4Status", "d5Status", "d6Status", "lastUpdated") 
    VALUES (gen_random_uuid(), patient_id, 'RED', 'RED', 'RED', 'RED', 'RED', 'RED', NOW());
    INSERT INTO elderly_indicators (id, "patientId", "f1Status", "f2Status", "lastUpdated") 
    VALUES (gen_random_uuid(), patient_id, 'RED', 'RED', NOW());
    ...
    patient_id := gen_random_uuid();
    INSERT INTO patients (id, cpf, cns, "fullName", "motherName", "birthDate", sex, street, number, neighborhood, state, "microAreaId", "primaryPhone", "isWoman", "createdById", "createdAt", "updatedAt")
    VALUES (patient_id, '20000000005', '200000000010005', 'Juliana Martins Rocha', 'Sandra Rocha', NOW() - INTERVAL '42 years', 'FEMALE', 'Rua Norte', '204', 'Bairro Norte', 'CE', ma02_id, '(85) 98888-8884', true, admin_id, NOW(), NOW());
    INSERT INTO woman_health_indicators (id, "patientId", "g1Status", "g2Status", "lastUpdated") 
    VALUES (gen_random_uuid(), patient_id, 'RED', 'RED', NOW());
END $$;

-- Mensagem de sucesso
SELECT 'Seed executado com sucesso! Total de registros:' as mensagem;
SELECT 'Microáreas: ' || COUNT(*) FROM micro_areas;
